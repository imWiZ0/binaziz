...
export default async function initial_data_seed({
      ...
      regions: [
        {
          ...
          currency_code: "sar",
          countries,
          payment_providers: ["pp_moyasar_default"],
        },
      ],
    },
  });
  ...
  // Link the OTO fulfillment provider to the stock location
  // The provider ID in the database will be "oto_oto" (module_id + provider_id)
